...
export function OneLinkAdminDashboard() {
  const { t } = useTranslation();
  const { role } = useRole();

  // Admin Dashboard Metrics (จากรูปที่แนบมา)
  const metrics = [
    {
      icon: Users,
      title: "Total Users",
  ...
  // Recent Activities (จากรูปที่แนบมา)
  ...
  return (
    <div className="p-6 space-y-6 bg-background">
      ...
      {/* Two Column Layout - ตามรูปที่แนบมา */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent Activities - Takes 2 columns (ซ้าย) */}
        ...
        {/* System Status - Takes 1 column (ขวา) */}
