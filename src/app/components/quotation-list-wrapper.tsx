...
import CustomerDetailPage from "@/imports/CustomerDetailPage-539-13133";
import { useEffect } from "react";
import "../styles/figma-quotation-list-theme.css";

export function QuotationListWrapper() {
  ...
  return (
    <div 
      className="figma-quotation-list w-full h-full overflow-auto"
      style={{
