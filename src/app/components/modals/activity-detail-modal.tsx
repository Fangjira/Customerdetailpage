...
export function ActivityDetailModal({
  ...
  useEffect(() => {
    if (activity) {
      ...
      setFormData({
        ...
        startTime:
          formatTimeForInput(activity.startTime) || "09:00",
        endTime:
          formatTimeForInput(activity.endTime) || "10:00",
        location: activity.location || "",
        siteBranch: activity.siteBranch || "",
        customer: activity.customer || "",
        customerContacts: activity.customerContact
  ...
  const removeContact = (name: string) => {
    updateField(
      "customerContacts",
      formData.customerContacts.filter((c) => c !== name),
    );
  };
  ...
  const removeAttendee = (name: string) => {
    updateField(
      "attendees",
      formData.attendees.filter((a) => a !== name),
    );
  };
  ...
  const handleAddShortNote = () => {
    if (shortNote.trim() === "" && selectedFiles.length === 0)
      return;
  ...
  const getActivityTypeIconLarge = (type: activity_types) => {
    ...
    switch (type) {
      ...
      case "site_survey":
        return <MapPinCheck className={iconClass} />;
  ...
  const getStatusBadge = () => {
    ...
    return (
      <Popover
        ...
        onOpenChange={setStatusBadgeOpen}
      >
    ...
    <Dialog open={!!activity && isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] sm:max-w-[600px] max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        {!isEditMode ? (
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      <Badge
                        className={cn(
                          ...
                          "text-[14px] px-2 py-1 rounded-full border shadow-none font-medium",
                        )}
                      >
            ...
            <div className="space-y-5 py-4">
              ...
              <div className="space-y-3">
                ...
                <div className="pl-6 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900 font-medium">
                      {activity.createdBy?.name || "คุณ (You)"}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  activity.services.length > 0 ? (
                    <div className="flex flex-wrap gap-1.5">
                      {activity.services.map((serviceValue) => (
                        ...
                        >
                          {serviceNames[
                            serviceValue as keyof typeof serviceNames
                          ] || serviceValue}
                        </Badge>
                      ))}
                    </div>
              ...
              <div className="space-y-3">
                ...
                <div className="pl-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 font-medium">
                      {activity.assignedTo || "คุณ"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 mb-1">
                      {t("ผู้เข้าร่วมที่จำเป็น")}
                    </p>
                    {activity.attendees &&
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {activity.attendees.map(
                          (attendee, index) => (
                            <span
                              key={index}
                              className="bg-[#f0edff] text-[#5f4bb6] px-2 py-0.5 rounded text-[10px] border border-[#e5e0ff] font-medium"
                            >
                              {attendee}
                            </span>
                          ),
                ...
                <div className="space-y-3 mt-6">
                  ...
                  <div className="pl-6 space-y-3">
                    {shortNotes.map((note) => (
                      <div
                        key={note.id}
                        className="bg-[#f5f3ff] border border-[#ede9fe] rounded-lg p-3 shadow-sm"
                      >
                        {note.text && (
                            ...
                            <div className="flex flex-wrap gap-2 mb-2">
                              {note.attachments.map(
                                (f, idx) => (
                                  <div
                                    key={idx}
                                    className="flex items-center gap-1 bg-white border px-2 py-1 rounded text-[10px] text-purple-700"
                                  >
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100 border-2 border-purple-200 rounded-xl p-4 mt-4">
                ...
                <div className="space-y-3">
                  <Textarea
                    ...
                    placeholder={t(
                      "calendar.short_note_placeholder",
                    )}
                    rows={2}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      onClick={handleAddShortNote}
                      disabled={
                        shortNote.trim() === "" &&
                        selectedFiles.length === 0
                      }
                      className="bg-purple-600 h-8 text-xs"
                    >
            ...
            <DialogFooter className="border-t border-[#ede9fe] pt-4">
              <div className="flex flex-col sm:flex-row gap-2 w-full justify-end">
                <Button
                  ...
                  className="border-[#ede9fe] text-[#6b7280] rounded-full px-6"
                >
          ...
          <>
            <DialogHeader className="border-b border-[#ede9fe] pb-3 sm:pb-4">
              <DialogTitle className="text-lg text-[#4c1d95] font-semibold">
              ...
              <div className="flex items-center justify-end absolute right-4 top-4">
                <Button
                  ...
                  className="h-8 w-8 p-0 text-[#9333ea]"
                >
                  <X className="h-4 w-4" />
                </Button>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("siteBranch", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-bold text-[#4c1d95]">
                    {t("ผู้ติดต่อฝั่งลูกค้า/ลีด") ||
                      "ผู้ติดต่อฝั่งลูกค้า/ลีด"}
                  </Label>
                ...
                <div className="space-y-2 col-span-1 sm:col-span-2">
                  <Label className="text-sm font-bold text-[#4c1d95]">
                    {t("ผู้เข้าร่วมที่จำเป็น (ทีมของเรา)") ||
                      "ผู้เข้าร่วมที่จำเป็น (ทีมของเรา)"}
                  </Label>
                  <Popover
                    open={openAttendee}
                    onOpenChange={setOpenAttendee}
                  >
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
