import svgPaths from "./svg-be6a9llx98";
...
function Text6() {
  return (
    <div className="absolute bg-[#faf5ff] border-[#e9d4ff] border-[1.223px] border-solid h-[26.418px] left-0 overflow-clip rounded-[12px] top-[21.99px] w-[225.782px]" data-name="Text">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-[9.99px] text-[#8200db] text-[12px] top-[2.99px]">HCP - Healthcare and Pharmaceutical</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[15.988px] relative shrink-0 w-[25.214px]" data-name="Heading 4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Bold','Noto_Sans_Thai:Bold',sans-serif] font-bold leading-[16px] relative shrink-0 text-[#364153] text-[12px] tracking-[0.3px] uppercase">ที่อยู่</p>
      </div>
    </div>
  );
}
...
function Button16() {
  return (
    <div className="absolute left-[313.67px] rounded-[41020500px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] size-[55.987px] top-[773.33px]" data-name="Button" style={{ backgroundImage: "linear-gradient(135deg, rgb(0, 188, 125) 0%, rgb(16, 214, 143) 100%)" }}>
      <Icon9 />
    </div>
  );
}
...
function PrimitiveButton2() {
  return (
    <div className="flex-[1_0_0] h-[35.988px] min-h-px min-w-px relative" data-name="Primitive.button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon12 />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[16.5px] left-[64.69px] text-[#1a1a2e] text-[11px] text-center top-[7.74px]">ที่อยู่ (0)</p>
      </div>
    </div>
  );
}
...
function TabList() {
  return (
    <div className="h-[37.21px] relative shrink-0 w-[343.219px]" data-name="Tab List">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-[1.223px] pr-[-125.097px] relative size-full">
        <PrimitiveButton />
        <PrimitiveButton1 />
        <PrimitiveButton2 />
        <PrimitiveButton3 />
...
function Paragraph44() {
  return (
    <div className="h-[16.504px] relative shrink-0 w-[141.314px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[16.5px] relative shrink-0 text-[#64748b] text-[11px]">จัดการผู้ติดต่อทั้งหมดของลูกค้า</p>
      </div>
    </div>
  );
}
...
function Button17() {
  return (
    <div className="bg-[#7bc9a6] h-[27.984px] relative rounded-[12px] shrink-0 w-[93.025px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon14 />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[15px] left-[60.47px] text-[10px] text-center text-white top-[4.48px]">เพิ่มผู้ติดต่อ</p>
      </div>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="absolute content-stretch flex h-[12.225px] items-start left-[-9.22px] top-[35.78px] w-[46.245px]" data-name="Primitive.label">
      <p className="font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[9px] relative shrink-0 text-[#64748b] text-[9px]">ชื่อ-นามสกุล</p>
    </div>
  );
}
...
function Container83() {
  return (
    <div className="absolute h-[52px] left-0 top-0 w-[93px]" data-name="Container">
      <PrimitiveLabel />
    </div>
  );
}
...
function PrimitiveLabel1() {
  return (
    <div className="absolute content-stretch flex h-[12.225px] items-start left-0 top-[8.56px] w-[31.193px]" data-name="Primitive.label">
      <p className="font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[9px] relative shrink-0 text-[#64748b] text-[9px]">ตำแหน่ง</p>
    </div>
  );
}
...
function PrimitiveLabel2() {
  return (
    <div className="absolute content-stretch flex h-[12.225px] items-start left-0 top-[8.56px] w-[19.293px]" data-name="Primitive.label">
      <p className="font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[9px] relative shrink-0 text-[#64748b] text-[9px]">อีเมล</p>
    </div>
  );
}
...
function PrimitiveLabel3() {
  return (
    <div className="absolute content-stretch flex h-[12.225px] items-start left-0 top-[36px] w-[33.084px]" data-name="Primitive.label">
      <p className="font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[9px] relative shrink-0 text-[#64748b] text-[9px]">โทรศัพท์</p>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="absolute h-[51.995px] left-[0.58px] top-[26.42px] w-[59.578px]" data-name="Container">
      <PrimitiveLabel2 />
      <PrimitiveLabel3 />
    </div>
  );
...
function Container84() {
  return (
    <div className="absolute h-[51.995px] left-[-9.22px] top-[58.78px] w-[59.578px]" data-name="Container">
      <PrimitiveLabel1 />
      <Container85 />
    </div>
  );
...
function TextInput() {
  return (
    <div className="absolute bg-[#f5f9ff] h-[28px] left-[36.78px] rounded-[12px] top-[58.78px] w-[94px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[12px] py-[4px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#64748b] text-[10px] w-[36px] whitespace-pre-wrap">CEO</p>
      </div>
      <div aria-hidden="true" className="absolute border-[1.223px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
  );
...
function Container86() {
  return <div className="absolute h-[52px] left-0 top-[179.94px] w-[119px]" data-name="Container" />;
}

function PhoneInput() {
  return (
    <div className="absolute bg-[#f5f9ff] border-[1.223px] border-[rgba(0,0,0,0)] border-solid h-[28px] left-[31.58px] overflow-clip rounded-[12px] top-[112.41px] w-[85px]" data-name="Phone Input">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[normal] left-[10.78px] text-[#64748b] text-[10px] top-[7.28px]">02-590-1234</p>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="absolute bg-[#f5f9ff] border-[1.223px] border-[rgba(0,0,0,0)] border-solid h-[28px] left-[32px] overflow-clip rounded-[12px] top-[85px] w-[97px]" data-name="Email Input">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[normal] left-[3.78px] text-[#64748b] text-[10px] top-[6.78px]">somchai.w@g.or.th</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="absolute bg-[#00a63e] h-[15.988px] left-[62px] rounded-[12px] top-[147px] w-[42.769px]" data-name="Text">
...
function Container87() {
  return (
    <div className="absolute content-stretch flex h-[18px] items-start left-[110px] pt-[3.992px] top-[143px] w-[14px]" data-name="Container">
      <Icon15 />
    </div>
  );
}
...
function Container82() {
  return (
    <div className="absolute h-[175px] left-[12.78px] top-[-17.22px] w-[124px]" data-name="Container">
      <Container83 />
      <Container84 />
      <TextInput />
      <Container86 />
...
function TextInput1() {
  return (
    <div className="absolute bg-[#f5f9ff] border-[1.223px] border-[rgba(0,0,0,0)] border-solid h-[28px] left-[48.78px] overflow-clip rounded-[12px] top-[10.78px] w-[96px]" data-name="Text Input">
      <p className="absolute font-['Arimo:Regular','Noto_Sans_Thai:Regular',sans-serif] font-normal leading-[normal] left-[5.78px] text-[#64748b] text-[10px] top-[6.78px]">นพ.สมชาย วงศ์ใหญ่</p>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="absolute bg-[#e5e7eb] h-[15.988px] left-[62px] rounded-[12px] top-[147px] w-[42.769px]" data-name="Text">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[7.223px] py-[1.223px] relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[8px] text-white">Primary</p>
      </div>
      <div aria-hidden="true" className="absolute border-[1.223px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function Container95() {
  return (
    <div className="absolute bg-[#f9fafb] border-[1.223px] border-[rgba(123,201,166,0.15)] border-solid h-[153px] left-[173.78px] rounded-[14px] top-[2.78px] w-[150px]" data-name="Container">
      <Container96 />
      <TextInput5 />
    </div>
  );
...
function Container88() {
  return (
    <div className="absolute bg-[#f9fafb] border-[1.223px] border-[rgba(123,201,166,0.15)] border-solid h-[153px] left-[-2.22px] rounded-[14px] top-[157.78px] w-[150px]" data-name="Container">
      <Container89 />
      <TextInput3 />
      <Container95 />
    </div>
...
function Container81() {
  return (
    <div className="absolute bg-[#f9fafb] border-[1.223px] border-[rgba(123,201,166,0.15)] border-solid h-[153px] left-[-0.21px] rounded-[14px] top-[3.63px] w-[150px]" data-name="Container">
      <Container82 />
      <TextInput1 />
      <Container88 />
    </div>
...
function Container102() {
  return (
    <div className="absolute bg-[#f9fafb] border-[1.223px] border-[rgba(123,201,166,0.15)] border-solid h-[153px] left-[174.79px] rounded-[14px] top-[3.63px] w-[150px]" data-name="Container">
      <Container103 />
      <TextInput7 />
    </div>
  );
...
function Container80() {
  return (
    <div className="h-[600.671px] relative shrink-0 w-full" data-name="Container">
      <Container81 />
      <Container102 />
    </div>
  );
...
function Container78() {
  return (
    <div className="content-stretch flex flex-col gap-[11.996px] h-[640.651px] items-start relative shrink-0 w-full" data-name="Container">
      <Container79 />
      <Container80 />
    </div>
  );
...
function TabPanel() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[343.219px]" data-name="Tab Panel">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pl-[3.992px] pr-[27.22px] relative rounded-[inherit] size-full">
        <Container78 />
      </div>
    </div>
  );
...
function PrimitiveDiv1() {
  return (
    <div className="absolute bg-[#f5f9ff] h-[725.309px] left-0 top-[64px] w-[393.647px]" data-name="Primitive.div">
