...
export const advancedMockData = {
  ...
  activities: [
    ...
    },
    {
      ...
      type: "customer_visit",
      customerId: "cust_001",
      title: "March Monthly Performance Review",
      description: "Discussion on March logistics efficiency and cost optimization",
      purpose: "relationship",
      status: "completed",
      interactionType: "onsite_visit",
      subcategory: "formal_face_to_face",
      ...
      scheduledTime: "10:00",
      startTime: new Date("2026-03-12T10:00:00"),
      endTime: new Date("2026-03-12T11:30:00"),
      location: "CP Group Office",
      assignedTo: "Sarah Johnson",
      outcome: "information_provided",
      notes: "Reviewed KPIs for Q1 so far. Customer satisfied with current service levels.",
    ...
    },
    {
      ...
      type: "sales_meeting",
      customerId: "cust_002",
      title: "New Warehouse Expansion Pitch",
      description: "Pitching for the new Bangna warehouse expansion project",
      purpose: "sales",
      status: "completed",
      interactionType: "onsite_visit",
      subcategory: "formal_face_to_face",
      ...
      endTime: new Date("2026-04-05T15:30:00"),
      location: "Bangna Branch",
      assignedTo: "Michael Chen",
      outcome: "quotation_requested",
      notes: "Customer requested a formal quotation by end of week.",
    ...
    },
    {
      ...
      description: "Routine check-in to ensure service satisfaction",
      purpose: "relationship",
      status: "completed",
      interactionType: "onsite_visit",
      subcategory: "informal_face_to_face",
      scheduledDate: "2026-04-15",
      scheduledTime: "09:30",
      startTime: new Date("2026-04-15T09:30:00"),
      endTime: new Date("2026-04-15T11:00:00"),
      location: "Toyota Gateway Plant",
      assignedTo: "Sarah Johnson",
      outcome: "follow_up_scheduled",
      notes: "Discussed minor issues with delivery timing. Scheduled deep dive with logistics team.",
    ...
    },
    {
      ...
      type: "sales_meeting",
      customerId: "cust_001",
      title: "Today's Strategy Session",
      description: "Urgent meeting to discuss upcoming peak season logistics",
      purpose: "sales",
      status: "planned",
      interactionType: "online_meeting",
      subcategory: "formal_online",
      ...
      scheduledTime: "11:00",
      startTime: new Date("2026-04-21T11:00:00"),
      endTime: new Date("2026-04-21T12:00:00"),
      location: "Google Meet",
      assignedTo: "Sarah Johnson",
      notes: "Review resource allocation for Songkran period.",
